...
void shared_mem_2D(DATA_TYPE* A, DATA_TYPE* B_dev, const int b_dim, int mat_dim)
{
	...
	shared_mem_kernel<<<blocksPerGrid, threadsPerBlock>>>(A_gpu, B_gpu, mat_dim, b_dim);
